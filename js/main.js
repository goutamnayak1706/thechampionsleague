...
(function () {
  ...
  const TEAM_COLORS = {
    'Asian Tigers':            '#e63946',
    'Minnal Blasters':         '#f77f00',
    'Maratha Challengers':     '#fcbf49',
    'Striker':                 '#2dc653',
    'Hollane Capitals Oranje': '#06aed5',
    'Power hitters':           '#7b2d8b',
    'Dutch Lords':             '#ff4d6d',
    'Den Haag Slayers':        '#ff9500',
    'GLADIATORS XI':           '#00b4d8',
    'Holland Capitals':        '#80b918',
    'Kombanz':                 '#e040fb',
    'Nieuwegein Sunrisers':    '#ff6b35',
    'Holland hellfire':        '#3a86ff',
    'Hoysala':                 '#f72585',
    'Arnhem Super Kings':      '#4cc9f0',
    'Utrecht Challengers':     '#f4d35e',
    'Smashers Xi':             '#43aa8b',
    'CB11':                    '#ef233c',
    'Kalinga warriors':        '#ffd166',
    'Titans XI':               '#06d6a0',
    'Wild Jaguars':            '#cb4154',
    'Minnal Rockers':          '#118ab2',
  };
